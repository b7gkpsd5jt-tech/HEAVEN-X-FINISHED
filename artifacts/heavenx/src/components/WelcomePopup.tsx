...
const DEFAULT_CONTENT = `تمام آثار داخل سایت قرار می‌گیرند. این سایت عمومی نیست و فقط کاربران مجاز می‌توانند وارد شوند.
            ...
            <div className="relative z-10 p-8">
              ...
              <div
                ...
                style={{
                  width: "64px",
                  height: "2px",
                  background: "linear-gradient(90deg, transparent, #60cfff, transparent)",
              ...
              {/* Body — Lalezar, white */}
              <p
                className="text-center whitespace-pre-line leading-8"
                style={{
